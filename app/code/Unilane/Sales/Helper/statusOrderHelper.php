            ...
            try {
                foreach($results as $result){
                    ...
                    if(@$connect["enviar"] == true){
                        ...
                        $mail->Password   = 'D11DB6B02A.123QAR';                               //SMTP password
                        $mail->SMTPSecure = 'tls';            //Enable implicit TLS encryption
                        $mail->Port       = '587';
                        $mail->CharSet    = 'UTF-8';
            
                        $nombre        = $result['customer_firstname'].' '.$result['customer_lastname'];
                        $correo        = $result['customer_email'];
                        $Estatus       = "";
                        $Guias         = "";
                        $Paqueteria    = "";
                        //FECHA DE CREACION
                        ...
                        $base_url = $protocol . '://' . $host .'/rastreo_de_envios';
                        //Recipients
                        ...
                        $mail->Subject = 'Rastrea tu pedido';
                        ...
                        <tbody><tr>
                            <td height="40" style="font-size:15px;line-height:40px;">&nbsp;</td>
                        </tr>
                        <tr style="">
                            <td class="center-text" align="center" style="font-family:Roboto, Arial, Helvetica, sans-serif;font-size:43px;line-height:48px;font-weight:500;font-style:normal;color:rgb(51, 51, 51);text-decoration:none;letter-spacing:0px;">
                                
                                <div style="margin: 0px; padding: 0px;"><p style="margin: 0px; padding: 0px;">¡Pedido enviado!</p><p style="margin: 0px; padding: 0px;">
                                </p></div>
                        ...
                        <tr>
                            <td class="center-text" align="center" style="font-family:Poppins, Arial, Helvetica, sans-serif;font-size:15px;line-height:22px;font-weight:300;font-style:normal;color:rgb(51, 51, 51);text-decoration:none;letter-spacing:0px;">
                                
                                <div style="margin: 0px; padding: 0px;"><p style="margin: 0px; padding: 0px;">'.$nombre.', tu pedido ha sido enviado y va en camino a su destino. Para conocer la ubicación en todo momento da click en el siguiente botón</p><p style="margin: 0px; padding: 0px;">
                                </p></div>
                        ...
                        <tr>
                            ...
                            <table border="0" cellspacing="0" cellpadding="0" role="presentation" align="center" class="center-float">
                                <tbody><tr>
                                <td align="center" bgcolor="#304f7f" style="border-radius:36px;">
                            <!--[if (gte mso 9)|(IE)]>
                                ...
                                <tr>
                                    ...
                                    <![endif]-->
                                        ...
                                        <a href='.$base_url.' style="font-family:"Poppins",Arial,Helvetica,sans-serif;font-size:16px;line-height:20px;font-weight:700;font-style:normal;color:#FFFFFF;text-decoration:none;letter-spacing:0px;padding:15px 35px 15px 35px;display:inline-block;"><span>Rastrear mi pedido</span></a>
                        ...
                        <tr>
                            ...
                            <table border="0" align="center" cellpadding="0" cellspacing="0" role="presentation" class="row" width="89.66%" style="width:89.66%;max-width:89.66%;">
                                ...
                                <td align="center">
                                    ...
                                    <table border="0" align="center" cellpadding="0" cellspacing="0" role="presentation" width="100%" style="width:100%;max-width:100%;">
                                    <tbody><tr style="">
                                        <td class="center-text" align="left" style="font-family:"Poppins",Arial,Helvetica,sans-serif;font-size:16px;line-height:20px;font-weight:400;font-style:normal;color:#333333;text-decoration:none;letter-spacing:0px;">
                                            
                                            <div style="margin: 0px; padding: 0px;"><p style="margin: 0px; padding: 0px;">Orden #<strong><font color="#304f7f">{{var order.increment_id|raw}}</font></strong><strong style="color:#E38529;"></strong></p><p style="margin: 0px; padding: 0px;">Fecha:<strong>{{var order.getCreatedAtFormatted(2)|raw}}</strong></p>
                                                </div>
                                    ...
                                    <tr style="">
                                        <td class="center-text" align="left" style="font-family:"Poppins",Arial,Helvetica,sans-serif;font-size:20px;line-height:24px;font-weight:700;font-style:normal;color:#333333;text-decoration:none;letter-spacing:0px;">
                                            
                                            <div style="margin: 0px; padding: 0px;"><p style="margin: 0px; padding: 0px;">Datos de Facturación</p><p style="margin: 0px; padding: 0px;">
                                            </p></div>
                                    ...
                                    <tr style="">
                                        <td class="center-text" align="left" style="font-family:Poppins, Arial, Helvetica, sans-serif;font-size:15px;line-height:22px;font-weight:300;font-style:normal;color:rgb(51, 51, 51);text-decoration:none;letter-spacing:0px;">
                                            
                                            <div style="margin: 0px; padding: 0px;"><p style="margin: 0px; padding: 0px;">{{var order.getBillingAddress().format(‘html’)}}</p><p style="margin: 0px; padding: 0px;">
                                            </p></div>
                                    ...
                                    <tbody><tr style="">
                                        <td class="center-text" align="left" style="font-family:"Poppins",Arial,Helvetica,sans-serif;font-size:20px;line-height:24px;font-weight:700;font-style:normal;color:#333333;text-decoration:none;letter-spacing:0px;">
                                            ...
                                            <div style="margin: 0px; padding: 0px;"><p style="margin: 0px; padding: 0px;">Dirección de envío<br></p><p style="margin: 0px; padding: 0px;">
                                            </p></div>
                                    ...
                                    <tr style="">
                                        <td class="center-text" align="left" style="font-family:Poppins, Arial, Helvetica, sans-serif;font-size:15px;line-height:22px;font-weight:300;font-style:normal;color:rgb(51, 51, 51);text-decoration:none;letter-spacing:0px;">
                                            ...
                                            <div style="margin: 0px; padding: 0px;"><p style="margin: 0px; padding: 0px;">{{var order.getShippingAddress().format(‘html’)}}</p>
                                            </div>
                        ...
                        <table data-inner-table="" border="0" align="center" cellpadding="0" cellspacing="0" role="presentation" class="inner-table row container-padding" width="580" style="width:580px;max-width:580px;">
                        <tbody><tr>
                            <td height="14" style="font-size:20px;line-height:14px;">&nbsp;</td>
                        </tr>
                        <tr>
                            <td align="center">
                            <!-- Content -->
                            <table border="0" align="center" cellpadding="0" cellspacing="0" role="presentation" class="row" width="89.66%" style="width:89.66%;max-width:89.66%;">
                                <tbody>                               
                                <tr>
                                <td height="33" style="font-size:30px;line-height:33px;">&nbsp;</td>
                                </tr>
                                <tr>
                                <td height="1" bgcolor="#DDDDDD" style="font-size:1px;line-height:1px;">&nbsp;</td>
                                </tr>
                                <tr>
                                <td height="25" style="font-size:20px;line-height:25px;">&nbsp;</td>
                                </tr>
                                <tr>
                                <td align="center">
                                    <!-- Paragraphs -->
                                    ...
                                    <tbody><tr>
                                        <td class="center-text" align="center" style="font-family:Poppins, Arial, Helvetica, sans-serif;font-size:13.5px;line-height:19px;font-weight:300;font-style:italic;color:rgb(51, 51, 51);text-decoration:none;letter-spacing:0px;">
                                            
                                            <div style="margin: 0px; padding: 0px;"><p style="margin: 0px; padding: 0px;">Si recibiste este correo es porque tu pedido ha sido entregado, en caso de no haberlo recibido por favor coméntanoslo para dar seguimiento y entregarlo lo más pronto posible.</p><p style="margin: 0px; padding: 0px;"><br></p><p style="margin: 0px; padding: 0px;">Puedes ver aquí los detalles de tu pedido. Ten en cuenta que si compraste varios productos, es posible que sean enviados por separado. Por favor revisa tu correo de confirmación para mayor información.</p></div>
                                ...
                                <td align="center">
                                    ...
                                    <table border="0" cellpadding="0" cellspacing="0" align="center">
                                        ...
                                        <![endif]-->
                                            ...
                                            <a href="#" style="font-family:"Poppins",Arial,Helvetica,sans-serif;font-size:16px;line-height:20px;font-weight:700;font-style:normal;color:#FFFFFF;text-decoration:none;letter-spacing:0px;padding:15px 35px 15px 35px;display:inline-block;"><span>Ver mi pedido</span></a>
                        ...
                        <tr>
                            ...
                            <table border="0" align="center" cellpadding="0" cellspacing="0" role="presentation">
                                ...
                                <td class="rwd-on-mobile center-text" align="center" style="font-family:Poppins, Arial, Helvetica, sans-serif;font-size:13px;line-height:20.5px;font-weight:300;font-style:normal;color:rgb(51, 51, 51);text-decoration:none;letter-spacing:0px;">
                                    <a href="#" style="font-family:"Poppins",Arial,Helvetica,sans-serif;font-size:14px;font-weight:300;line-height:24px;color:#333333;text-decoration:none;">Aviso de Privacidad</a>
                                </td>
                                ...
                                <td class="rwd-on-mobile center-text" align="center" style="font-family:Poppins, Arial, Helvetica, sans-serif;font-size:13px;line-height:20.5px;font-weight:300;font-style:normal;color:rgb(51, 51, 51);text-decoration:none;letter-spacing:0px;">
                                    <a href="#" style="font-family:"Poppins",Arial,Helvetica,sans-serif;font-size:14px;font-weight:300;line-height:24px;color:#333333;text-decoration:none;">Términos y Condiciones</a>
                                </td>
                                ...
                                <td class="rwd-on-mobile center-text" align="center" style="font-family:Poppins, Arial, Helvetica, sans-serif;font-size:13px;line-height:20.5px;font-weight:300;font-style:normal;color:rgb(51, 51, 51);text-decoration:none;letter-spacing:0px;">
                                    <a href="#" style="font-family:"Poppins",Arial,Helvetica,sans-serif;font-size:14px;font-weight:300;line-height:24px;color:#333333;text-decoration:none;">Unsubscribe</a>
                                </td>
                                </tr>
                            </tbody></table>
                            </td>
