...
class Interceptor extends \Mageplaza\LayeredNavigation\Model\ResourceModel\Fulltext\Collection implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getCollectionClone');
        return $pluginInfo ? $this->___callPlugins('getCollectionClone', func_get_args(), $pluginInfo) : parent::getCollectionClone($isReturn);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'removeAttributeSearch');
        return $pluginInfo ? $this->___callPlugins('removeAttributeSearch', func_get_args(), $pluginInfo) : parent::removeAttributeSearch($attributeCode);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'addLayerCategoryFilter');
        return $pluginInfo ? $this->___callPlugins('addLayerCategoryFilter', func_get_args(), $pluginInfo) : parent::addLayerCategoryFilter($categories);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'resetCategoryFilter');
        return $pluginInfo ? $this->___callPlugins('resetCategoryFilter', func_get_args(), $pluginInfo) : parent::resetCategoryFilter($categoryIds);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'setCategoryFilter');
        return $pluginInfo ? $this->___callPlugins('setCategoryFilter', func_get_args(), $pluginInfo) : parent::setCategoryFilter($categoryIds);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'resetCategoryIds');
        return $pluginInfo ? $this->___callPlugins('resetCategoryIds', func_get_args(), $pluginInfo) : parent::resetCategoryIds($categoryIds);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'resetTotalRecords');
        return $pluginInfo ? $this->___callPlugins('resetTotalRecords', func_get_args(), $pluginInfo) : parent::resetTotalRecords();
    }
    ...
    public function setSearch(\Magento\Search\Api\SearchInterface $object)
    {
        ...
        return $pluginInfo ? $this->___callPlugins('setSearch', func_get_args(), $pluginInfo) : parent::setSearch($object);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'setSearchCriteriaBuilder');
        return $pluginInfo ? $this->___callPlugins('setSearchCriteriaBuilder', func_get_args(), $pluginInfo) : parent::setSearchCriteriaBuilder($object);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'setFilterBuilder');
        return $pluginInfo ? $this->___callPlugins('setFilterBuilder', func_get_args(), $pluginInfo) : parent::setFilterBuilder($object);
    }
    ...
    public function addSearchFilter($query)
    {
        ...
        return $pluginInfo ? $this->___callPlugins('addSearchFilter', func_get_args(), $pluginInfo) : parent::addSearchFilter($query);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'setGetAllData');
        return $pluginInfo ? $this->___callPlugins('setGetAllData', func_get_args(), $pluginInfo) : parent::setGetAllData($isGetAll);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'setGeneralDefaultQuery');
        return $pluginInfo ? $this->___callPlugins('setGeneralDefaultQuery', func_get_args(), $pluginInfo) : parent::setGeneralDefaultQuery();
    }
