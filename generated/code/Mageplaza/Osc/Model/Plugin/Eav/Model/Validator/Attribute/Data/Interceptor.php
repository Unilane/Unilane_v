...
class Interceptor extends \Mageplaza\Osc\Model\Plugin\Eav\Model\Validator\Attribute\Data implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'afterIsValid');
        return $pluginInfo ? $this->___callPlugins('afterIsValid', func_get_args(), $pluginInfo) : parent::afterIsValid($subject, $result);
    }
