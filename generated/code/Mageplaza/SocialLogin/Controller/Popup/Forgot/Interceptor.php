...
class Interceptor extends \Mageplaza\SocialLogin\Controller\Popup\Forgot implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'checkCaptcha');
        return $pluginInfo ? $this->___callPlugins('checkCaptcha', func_get_args(), $pluginInfo) : parent::checkCaptcha();
    }
