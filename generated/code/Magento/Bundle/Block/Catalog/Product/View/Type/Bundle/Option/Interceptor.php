...
class Interceptor extends \Magento\Bundle\Block\Catalog\Product\View\Type\Bundle\Option implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'showSingle');
        return $pluginInfo ? $this->___callPlugins('showSingle', func_get_args(), $pluginInfo) : parent::showSingle();
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getDefaultValues');
        return $pluginInfo ? $this->___callPlugins('getDefaultValues', func_get_args(), $pluginInfo) : parent::getDefaultValues();
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'isSelected');
        return $pluginInfo ? $this->___callPlugins('isSelected', func_get_args(), $pluginInfo) : parent::isSelected($selection);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getSelectionQtyTitlePrice');
        return $pluginInfo ? $this->___callPlugins('getSelectionQtyTitlePrice', func_get_args(), $pluginInfo) : parent::getSelectionQtyTitlePrice($selection, $includeContainer);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getSelectionPrice');
        return $pluginInfo ? $this->___callPlugins('getSelectionPrice', func_get_args(), $pluginInfo) : parent::getSelectionPrice($selection);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getSelectionTitlePrice');
        return $pluginInfo ? $this->___callPlugins('getSelectionTitlePrice', func_get_args(), $pluginInfo) : parent::getSelectionTitlePrice($selection, $includeContainer);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'setValidationContainer');
        return $pluginInfo ? $this->___callPlugins('setValidationContainer', func_get_args(), $pluginInfo) : parent::setValidationContainer($elementId, $containerId);
    }
    ...
    public function setOption(\Magento\Bundle\Model\Option $option)
    {
        ...
        return $pluginInfo ? $this->___callPlugins('setOption', func_get_args(), $pluginInfo) : parent::setOption($option);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'renderPriceString');
        return $pluginInfo ? $this->___callPlugins('renderPriceString', func_get_args(), $pluginInfo) : parent::renderPriceString($selection, $includeContainer);
    }
    ...
    public function getWebsite($storeId)
    {
        ...
        return $pluginInfo ? $this->___callPlugins('getWebsite', func_get_args(), $pluginInfo) : parent::getWebsite($storeId);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getDisplayMinimalPrice');
        return $pluginInfo ? $this->___callPlugins('getDisplayMinimalPrice', func_get_args(), $pluginInfo) : parent::getDisplayMinimalPrice();
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'setIdSuffix');
        return $pluginInfo ? $this->___callPlugins('setIdSuffix', func_get_args(), $pluginInfo) : parent::setIdSuffix($idSuffix);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getIdSuffix');
        return $pluginInfo ? $this->___callPlugins('getIdSuffix', func_get_args(), $pluginInfo) : parent::getIdSuffix();
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getRealPriceJs');
        return $pluginInfo ? $this->___callPlugins('getRealPriceJs', func_get_args(), $pluginInfo) : parent::getRealPriceJs($product);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'prepareSku');
        return $pluginInfo ? $this->___callPlugins('prepareSku', func_get_args(), $pluginInfo) : parent::prepareSku($sku);
    }
