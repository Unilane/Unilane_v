<?php
namespace Magento\PageBuilder\Ui\Component\Listing\Columns\TemplateManagerActions;

/**
 * Interceptor class for @see \Magento\PageBuilder\Ui\Component\Listing\Columns\TemplateManagerActions
 */
class Interceptor extends \Magento\PageBuilder\Ui\Component\Listing\Columns\TemplateManagerActions implements \Magento\Framework\Interception\InterceptorInterface
{
    use \Magento\Framework\Interception\Interceptor;

    public function __construct(\Magento\Framework\View\Element\UiComponent\ContextInterface $context, \Magento\Framework\View\Element\UiComponentFactory $uiComponentFactory, \Magento\Framework\Escaper $escaper, \Magento\Framework\UrlInterface $urlBuilder, \Magento\Framework\AuthorizationInterface $authorization, array $components = [], array $data = [])
    {
        $this->___init();
        parent::__construct($context, $uiComponentFactory, $escaper, $urlBuilder, $authorization, $components, $data);
    }
    ...
    public function getComponentName()
    {
        ...
        return $pluginInfo ? $this->___callPlugins('getComponentName', func_get_args(), $pluginInfo) : parent::getComponentName();
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'prepareItems');
        return $pluginInfo ? $this->___callPlugins('prepareItems', func_get_args(), $pluginInfo) : parent::prepareItems($items);
    }
    ...
    public function getContext()
    {
        ...
        return $pluginInfo ? $this->___callPlugins('getContext', func_get_args(), $pluginInfo) : parent::getContext();
    }
    ...
    public function render()
    {
        ...
        return $pluginInfo ? $this->___callPlugins('render', func_get_args(), $pluginInfo) : parent::render();
    }
    ...
    public function addComponent($name, \Magento\Framework\View\Element\UiComponentInterface $component)
    {
        ...
        return $pluginInfo ? $this->___callPlugins('addComponent', func_get_args(), $pluginInfo) : parent::addComponent($name, $component);
    }
    ...
    public function getComponent($name)
    {
        ...
        return $pluginInfo ? $this->___callPlugins('getComponent', func_get_args(), $pluginInfo) : parent::getComponent($name);
    }
    ...
    public function renderChildComponent($name)
    {
        ...
        return $pluginInfo ? $this->___callPlugins('renderChildComponent', func_get_args(), $pluginInfo) : parent::renderChildComponent($name);
    }
    ...
    public function getJsConfig(\Magento\Framework\View\Element\UiComponentInterface $component)
    {
        ...
        return $pluginInfo ? $this->___callPlugins('getJsConfig', func_get_args(), $pluginInfo) : parent::getJsConfig($component);
    }
    ...
    public function getDataSourceData()
    {
        ...
        return $pluginInfo ? $this->___callPlugins('getDataSourceData', func_get_args(), $pluginInfo) : parent::getDataSourceData();
    }
