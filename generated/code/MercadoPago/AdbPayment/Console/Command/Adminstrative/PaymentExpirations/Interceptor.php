<?php
namespace MercadoPago\AdbPayment\Console\Command\Adminstrative\PaymentExpirations;

/**
 * Interceptor class for @see \MercadoPago\AdbPayment\Console\Command\Adminstrative\PaymentExpirations
 */
class Interceptor extends \MercadoPago\AdbPayment\Console\Command\Adminstrative\PaymentExpirations implements \Magento\Framework\Interception\InterceptorInterface
{
    use \Magento\Framework\Interception\Interceptor;

    public function __construct(\Magento\Framework\App\State $state, \MercadoPago\AdbPayment\Model\Console\Command\Adminstrative\PaymentExpiration $paymentExpiration)
    {
        $this->___init();
        parent::__construct($state, $paymentExpiration);
    }
