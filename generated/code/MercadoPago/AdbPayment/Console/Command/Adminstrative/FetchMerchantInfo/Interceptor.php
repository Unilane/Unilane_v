<?php
namespace MercadoPago\AdbPayment\Console\Command\Adminstrative\FetchMerchantInfo;

/**
 * Interceptor class for @see \MercadoPago\AdbPayment\Console\Command\Adminstrative\FetchMerchantInfo
 */
class Interceptor extends \MercadoPago\AdbPayment\Console\Command\Adminstrative\FetchMerchantInfo implements \Magento\Framework\Interception\InterceptorInterface
{
    use \Magento\Framework\Interception\Interceptor;

    public function __construct(\Magento\Framework\App\State $state, \MercadoPago\AdbPayment\Model\Console\Command\Adminstrative\FetchMerchant $fetchMerchant)
    {
        $this->___init();
        parent::__construct($state, $fetchMerchant);
    }
