<?php
namespace MercadoPago\AdbPayment\Console\Command\Notification\FetchOrderStatus;

/**
 * Interceptor class for @see \MercadoPago\AdbPayment\Console\Command\Notification\FetchOrderStatus
 */
class Interceptor extends \MercadoPago\AdbPayment\Console\Command\Notification\FetchOrderStatus implements \Magento\Framework\Interception\InterceptorInterface
{
    use \Magento\Framework\Interception\Interceptor;

    public function __construct(\Magento\Framework\App\State $state, \MercadoPago\AdbPayment\Model\Console\Command\Notification\FetchStatus $fetchStatus)
    {
        $this->___init();
        parent::__construct($state, $fetchStatus);
    }
