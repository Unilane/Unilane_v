<?php
namespace MercadoPago\AdbPayment\Console\Command\Notification\CheckoutProAddChild;

/**
 * Interceptor class for @see \MercadoPago\AdbPayment\Console\Command\Notification\CheckoutProAddChild
 */
class Interceptor extends \MercadoPago\AdbPayment\Console\Command\Notification\CheckoutProAddChild implements \Magento\Framework\Interception\InterceptorInterface
{
    use \Magento\Framework\Interception\Interceptor;

    public function __construct(\Magento\Framework\App\State $state, \MercadoPago\AdbPayment\Model\Console\Command\Notification\CheckoutProAddChildPayment $checkoutProAddChild)
    {
        $this->___init();
        parent::__construct($state, $checkoutProAddChild);
    }
