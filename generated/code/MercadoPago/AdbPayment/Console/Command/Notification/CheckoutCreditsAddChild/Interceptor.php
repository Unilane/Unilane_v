<?php
namespace MercadoPago\AdbPayment\Console\Command\Notification\CheckoutCreditsAddChild;

/**
 * Interceptor class for @see \MercadoPago\AdbPayment\Console\Command\Notification\CheckoutCreditsAddChild
 */
class Interceptor extends \MercadoPago\AdbPayment\Console\Command\Notification\CheckoutCreditsAddChild implements \Magento\Framework\Interception\InterceptorInterface
{
    use \Magento\Framework\Interception\Interceptor;

    public function __construct(\Magento\Framework\App\State $state, \MercadoPago\AdbPayment\Model\Console\Command\Notification\CheckoutCreditsAddChildPayment $checkoutCreditsAddChild)
    {
        $this->___init();
